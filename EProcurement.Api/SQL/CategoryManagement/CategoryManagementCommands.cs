namespace EProcurement.Api.SQL.CategoryManagement
{
    public static class CategoryManagementCommands
    {
        ...
        public const string UpdateSubClassification = @"EXEC SP_SubClassification_Update @SubClassificationID, @ClassificationID, @Code, @Name, @IsActive, @User, @DeletedAt, @DeletedBy";
    }
}